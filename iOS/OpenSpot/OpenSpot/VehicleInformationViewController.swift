...
class VehicleInformationViewController: UIViewController, UITextFieldDelegate, UIPickerViewDataSource, UIPickerViewDelegate, UIAlertViewDelegate {
    ...
    var carDict: [String: [String]] = ["-SELECT-": ["-SELECT-"],
                                       "Acura": ["-SELECT-","ILX", "MDX", "MDX Sport Hybrid", "NSX", "RDX", "RLX", "RLX Sport Hybrid", "TLX"],
                                       "Alfa Romeo": ["-SELECT-","4C", "4C Spider", "Giulia", "Stelvio"],
                                       "Aston Martin": ["-SELECT-","DB11", "Vanquish S"],
                                       "Audi": ["-SELECT-","A3", "A3 Sportback e-tron", "A4", "A4 allroad", "A5", "A6", "A7", "A8", "e-tron", "Q3", "Q5", "Q7", "Q8", "R8", "RS 3", "RS 5", "RS 7", "S3", "S4", "S5", "S6", "S7", "S8", "SQ5", "TT"],
                                       "Bentley": ["-SELECT-","Bentayga", "Continental", "Flying Spur", "Mulsanne"],
                                       "BMW": ["-SELECT-","2 Series", "3 Series", "4 Series", "5 Series", "6 Series", "7 Series", "i3", "i8", "M2", "M3", "M4", "M5", "M6", "X1", "X2", "X3", "X4", "X5", "X5 M", "X6", "X6 M"],
                                       "Buick": ["-SELECT-","Cascada", "Enclave", "Encore", "Envision", "LaCrosse", "Regal Sportback", "Regal TourX"],
                                       "Cadillac": ["-SELECT-","ATS", "ATS-V", "CT6", "CTS", "CTS-V", "Escalade", "Escalade ESV", "XT4", "XT5", "XTS"],
                                       "Chevrolet": ["-SELECT-","Blazer", "Bolt EV", "Camaro", "City Express", "Colorado Crew Cab", "Colorado Extended Cab", "Corvette", "Cruze", "Equinox", "Express 2500 Cargo", "Express 2500 Passenger", "Express 3500 Cargo", "Express 3500 Passenger", "Impala", "Malibu", "Silverado 1500 Crew Cab", "Silverado 1500 Double Cab", "Silverado 1500 LD Double Cab", "Silverado 1500 Regular Cab", "Silverado 2500 HD Crew Cab", "Silverado 2500 HD Double Cab", "Silverado 2500 HD Regular Cab", "Silverado 3500 HD Crew Cab", "Silverado 3500 HD Double Cab", "Silverado 3500 HD Regular Cab", "Sonic", "Spark", "Suburban", "Tahoe", "Traverse", "Trax", "Volt"],
                                       "Chrysler": ["-SELECT-","300", "Pacifica", "Pacifica Hybrid"],
                                       "Dodge": ["-SELECT-","Challenger", "Charger", "Durango", "Grand Caravan Passenger", "Journey"],
                                       "Ferrari": ["-SELECT-","488 GTB", "488 Spider", "812 Superfast", "California", "F12berlinetta", "GTC4Lusso", "Portofino"],
                                       "FIAT": ["-SELECT-","124 Spider", "500", "500 Abarth", "500c", "500c Abarth", "500e", "500L", "500X"],
                                       "Ford": ["-SELECT-","C-MAX Hybrid", "EcoSport", "Edge", "Escape", "Expedition", "Expedition MAX", "Explorer", "F150 Regular Cab", "F150 Super Cab", "F150 SuperCrew Cab", "F250 Super Duty Crew Cab", "F250 Super Duty Regular Cab", "F250 Super Duty Super Cab", "F350 Super Duty Crew Cab", "F350 Super Duty Regular Cab", "F350 Super Duty Super Cab", "F450 Super Duty Crew Cab", "Fiesta", "Flex", "Focus", "Fusion", "Fusion Energi", "Mustang", "Ranger SuperCab", "Ranger SuperCrew", "Taurus", "Transit 150 Van", "Transit 150 Wagon", "Transit 250 Van", "Transit 350 HD Van", "Transit 350 Van", "Transit 350 Wagon", "Transit Connect Cargo", "Transit Connect Passenger"],
                                       "Freightliner": ["-SELECT-","Sprinter 2500 Cargo", "Sprinter 2500 Crew", "Sprinter 2500 Passenger", "Sprinter 3500 Cargo", "Sprinter 3500XD Cargo", "Sprinter WORKER Cargo"],
                                       "Genesis": ["-SELECT-","G70", "G80", "G90"],
                                       "GMC": ["-SELECT-","Acadia", "Canyon Crew Cab", "Canyon Extended Cab", "Savana 2500 Cargo", "Savana 2500 Passenger", "Savana 3500 Cargo", "Savana 3500 Passenger", "Sierra 1500 Crew Cab", "Sierra 1500 Double Cab", "Sierra 1500 Regular Cab", "Sierra 2500 HD Crew Cab", "Sierra 2500 HD Double Cab", "Sierra 2500 HD Regular Cab", "Sierra 3500 HD Crew Cab", "Sierra 3500 HD Double Cab", "Sierra 3500 HD Regular Cab", "Terrain", "Yukon", "Yukon XL"],
                                       "Honda": ["-SELECT-","Accord", "Accord Hybrid", "Civic", "Civic Type R", "Clarity Electric", "Clarity Fuel Cell", "Clarity Plug-in Hybrid", "CR-V", "Fit", "HR-V", "Insight", "Odyssey", "Passport", "Pilot", "Ridgeline"],
                                       "Hyundai": ["-SELECT-","Accent", "Elantra", "Elantra GT", "Ioniq Electric", "Ioniq Hybrid", "Ioniq Plug-in Hybrid", "Kona", "Kona Electric", "NEXO", "Santa Fe", "Santa Fe Sport", "Santa Fe XL", "Sonata", "Sonata Hybrid", "Sonata Plug-in Hybrid", "Tucson", "Veloster"],
                                       "INFINITI": ["-SELECT-","Q50", "Q60", "Q70", "QX30", "QX50", "QX60", "QX80"],
                                       "Jaguar": ["-SELECT-","E-PACE", "F-PACE", "F-TYPE", "I-PACE", "XE", "XF", "XJ"],
                                       "Jeep": ["-SELECT-","Cherokee", "Compass", "Grand Cherokee", "Renegade", "Wrangler", "Wrangler Unlimited"],
                                       "Kia": ["-SELECT-","Cadenza", "Forte", "Forte5", "K900", "Niro", "Niro Plug-in Hybrid", "Optima", "Optima Hybrid", "Optima Plug-in Hybrid", "Rio", "Sedona", "Sorento", "Soul", "Soul EV", "Sportage", "Stinger", "Telluride"],
                                       "Lamborghini": ["-SELECT-","Aventador", "Huracan"],
                                       "Land Rover": ["-SELECT-","Discovery", "Discovery Sport", "Range Rover", "Range Rover Evoque", "Range Rover Sport", "Range Rover Velar"],
                                       "Lexus": ["-SELECT-","ES", "GS", "GX", "IS", "LC", "LS", "LX", "NX", "RC", "RX", "UX"],
                                       "Lincoln": ["-SELECT-","Aviator", "Continental", "MKC", "MKT", "MKX", "MKZ", "Nautilus", "Navigator", "Navigator L"],
                                       "Lotus": ["-SELECT-","Evora 400"],
                                       "Maserati": ["-SELECT-","Ghibli", "GranTurismo", "Levante", "Quattroporte"],
                                       "MAZDA": ["-SELECT-","CX-3", "CX-5", "CX-9", "MAZDA3", "MAZDA6", "MX-5 Miata", "MX-5 Miata RF"],
                                       "McLaren": ["-SELECT-","570GT", "570S", "720S"],
                                       "Mercedes-Benz": ["-SELECT-","A-Class", "C-Class", "CLA", "CLS", "E-Class", "G-Class", "GLA", "GLC", "GLC Coupe", "GLE", "GLS", "Mercedes-AMG C-Class", "Mercedes-AMG CLA", "Mercedes-AMG CLS", "Mercedes-AMG E-Class", "Mercedes-AMG G-Class", "Mercedes-AMG GLA", "Mercedes-AMG GLC", "Mercedes-AMG GLC Coupe", "Mercedes-AMG GLE", "Mercedes-AMG GLE Coupe", "Mercedes-AMG GLS", "Mercedes-AMG GT", "Mercedes-AMG S-Class", "Mercedes-AMG SL", "Mercedes-AMG SLC", "Mercedes-Maybach S-Class", "Metris Cargo", "Metris Passenger", "Metris WORKER Cargo", "Metris WORKER Passenger", "S-Class", "SL", "SLC", "Sprinter 2500 Cargo", "Sprinter 2500 Crew", "Sprinter 2500 Passenger", "Sprinter 3500 Cargo", "Sprinter 3500 XD Cargo", "Sprinter WORKER Cargo"],
                                       "MINI": ["-SELECT-","Clubman", "Convertible", "Countryman", "Hardtop 2 Door", "Hardtop 4 Door"],
                                       "Mitsubishi": ["-SELECT-","Eclipse Cross", "Mirage", "Mirage G4", "Outlander", "Outlander PHEV", "Outlander Sport"],
                                       ...
                                       "Porsche": ["-SELECT-","718 Boxster", "718 Cayman", "911", "Cayenne", "Macan", "Panamera"],
                                       "Ram": ["-SELECT-","1500 Classic Crew Cab", "1500 Classic Quad Cab", "1500 Classic Regular Cab", "1500 Crew Cab", "1500 Quad Cab", "1500 Regular Cab", "2500 Crew Cab", "2500 Mega Cab", "2500 Regular Cab", "3500 Crew Cab", "3500 Mega Cab", "3500 Regular Cab", "ProMaster Cargo Van", "ProMaster City", "ProMaster Window Van"],
                                       "Rolls-Royce": ["-SELECT-","Dawn", "Ghost", "Phantom", "Wraith"],
                                       "smart": ["-SELECT-","fortwo electric drive", "fortwo electric drive cabrio"],
                                       "Subaru": ["-SELECT-","Ascent", "BRZ", "Crosstrek", "Forester", "Impreza", "Legacy", "Outback", "WRX"],
                                       "Tesla": ["-SELECT-","Model 3", "Model S", "Model X", "Model Y", "Roadster"],
                                       "Toyota": ["-SELECT-","4Runner", "86", "Avalon", "Avalon Hybrid", "Camry", "Camry Hybrid", "C-HR", "Corolla", "Corolla Hatchback", "Corolla iM", "Highlander", "Highlander Hybrid", "Land Cruiser", "Mirai", "Prius", "Prius c", "Prius Prime", "RAV4", "RAV4 Hybrid", "Sequoia", "Sienna", "Tacoma Access Cab", "Tacoma Double Cab", "Tundra CrewMax", "Tundra Double Cab", "Yaris", "Yaris iA"],
                                       "Volkswagen": ["-SELECT-","Atlas", "Beetle", "e-Golf", "Golf", "Golf Alltrack", "Golf GTI", "Golf R", "Golf SportWagen", "Jetta", "Passat", "Tiguan", "Tiguan Limited"],
                                       "Volvo": ["-SELECT-","S60", "S90", "V60", "V90", "XC40", "XC60", "XC90"]
    ]
