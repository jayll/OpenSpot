...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/FirebaseUI-Auth-Phone/FirebaseAuthUI.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/FirebaseUI-Auth-Phone/FirebasePhoneAuthUI.bundle"
